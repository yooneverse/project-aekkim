...
class WatchaPromotionScraper(PromotionScraper):
        ...
        try:
            ...
            for keyword in PROMO_KEYWORDS:
                if keyword in full_text:
                    results.append({
                        "platform": "watcha",
                        "title":    f"왓챠 홈페이지 '{keyword}' 키워드 감지",
                        "date":     today,
                        "content":  full_text,
                    })
...
if __name__ == "__main__":
    import json
    scraper = WatchaPromotionScraper()

    print("=== WatchaPromotionScraper 테스트 ===\n")

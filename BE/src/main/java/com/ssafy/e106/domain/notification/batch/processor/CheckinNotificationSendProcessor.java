...
public class CheckinNotificationSendProcessor implements ItemProcessor<Notification, CheckinSendTarget> {

  private final FcmTokenRepository fcmTokenRepository;

  @Override
  public CheckinSendTarget process(Notification item) {

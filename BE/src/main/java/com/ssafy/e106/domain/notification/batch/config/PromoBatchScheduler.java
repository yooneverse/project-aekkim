...
public class PromoBatchScheduler {

  private static final String JOB_NAME = "promo-target-selection";
  ...
  public void runPromoTargetSelectionJob() throws Exception {
    ...
    try {
      ...
      jobLauncher.run(promoTargetSelectionJob, jobParameters);
    } finally {
